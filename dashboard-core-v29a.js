(function(){
  const SECTION_LAYOUT_KEY='td_layout_v29a_sections';
  const TILE_LAYOUT_KEYS={commands:'td_layout_v29a_commands',clocks:'td_layout_v29a_clocks',assets:'td_layout_v29a_assets'};
  const SECTION_SIZE_KEY='td_layout_v29a_sizes';
